                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-5 col-md-5">
                            <div className="social-icons">
                                <ul className="list-inline">
                                    <li><a href={this.props.twitterLink} rel="noopener noreferrer" target="http://www.twitter.com/erinjerri"><Icofont icon="icofont-twitter" /></a></li>
                                    <li><a href={this.props.twitchLink} rel="noopener noreferrer" target="http://www.twitch.tv/erinjerri"><Icofont icon="icofont-twitch" /></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
...
//Default Props
NavBar.defaultProps = {
    MainLogo: require('../assets/img/e-logo-50.png'),
    Logo2: require('../assets/img/e-logo-50.png'),
